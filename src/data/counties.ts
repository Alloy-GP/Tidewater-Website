...
// Ported from the county-template handoff. SHELL / PLACEHOLDER DATA:
// Howard & Carroll numbers, manager names, and resource URLs are
// unverified placeholders — Justin replaces with real content before
// these come off noindex. Do NOT publish community counts or client names.
...
export const COUNTIES: Record<string, County> = {
  'howard-county': {
    ...
    seo: {
      ...
      description: 'AAMC-accredited HOA & condo association management across Howard County — Columbia, Ellicott City, Elkridge, Fulton, Clarksville. Local PCAM manager. Family-owned since 1989.',
    ...
    hero: {
      ...
      lede: 'From Columbia’s village associations to Ellicott City’s historic-district condos to new Fulton and Clarksville developments — we’ve managed Howard County communities for 26 years. One named, PCAM-credentialed manager who lives in the county.',
      stats: [
        { num: '1999', label: 'Managing Howard County associations since' },
        { num: 'AAMC®', label: 'CAI’s highest accreditation · PCAM on staff', gold: true },
        { num: '< 1 hr', label: 'On-site response time, county-wide' },
      ],
    },
    intro: {
      ...
      body: [
        'Columbia alone accounts for roughly half the county’s HOA-governed homes — and its village-association structure, layered under the Columbia Association, creates a governance model that exists almost nowhere else in Maryland. Boards there manage sub-association budgets and CA assessments at the same time.',
        ...
        'A manager who only knows one of those four does not know Howard County. Ours works all four every week.',
      ],
      atAGlance: [
        { label: 'HOA-governed homes', value: '46,200+' },
        { label: 'Associations county-wide', value: '610+' },
        { label: 'Managing here since', value: '1999' },
        { label: 'Median assessment', value: '$285/mo' },
      ],
    },
    cities: {
      eyebrow: 'Cities & Towns We Serve',
      title: 'Every Howard County community we manage, <em>by city.</em>',
      lede: 'Nine town pages sit under this one. Pick yours — each covers the local association types, the neighborhoods we cover, and what management costs there.',
      list: [
        { name: 'Columbia', slug: 'columbia', focus: 'Village associations · Condo', note: 'Village associations, CA-layered governance, mid-rise condos', tag: 'Largest market', hasPage: true },
        { name: 'Ellicott City', slug: 'ellicott-city', focus: 'Single-family · Condo', note: 'Historic-district review, stormwater reserve planning', tag: 'County seat', hasPage: true },
        { name: 'Elkridge', slug: 'elkridge', focus: 'Townhome HOA', note: 'Townhome HOAs, high tenant ratio, BWI corridor', hasPage: true },
        { name: 'Fulton', slug: 'fulton', focus: 'Master-planned · New build', note: 'New construction, developer transition & warranty claims', tag: 'Growing', hasPage: true },
        { name: 'Clarksville', slug: 'clarksville', focus: 'Single-family HOA', note: 'Large-lot single-family, private-road maintenance', hasPage: true },
        { name: 'Jessup', slug: 'jessup', focus: 'Townhome · Garden condo', note: 'Townhome & garden condo, mixed-use adjacency', hasPage: true },
        { name: 'Laurel', slug: 'laurel', focus: 'Garden-style condo', note: 'Shared PG County line, garden-style condo', hasPage: true },
        { name: 'Savage', slug: 'savage', focus: 'Small association', note: 'Historic mill district, small-association scale', hasPage: true },
    ...
    local: {
      ...
      cards: [
        ...
        { tone: 'sage', meta: 'MD Code Real Prop. §11B', title: 'Reserve study cadence', body: 'Maryland requires HOAs to complete a reserve study and update funding plans on a <strong>rolling 5-year cycle</strong>. Howard County’s newer associations are hitting their first-ever deadline now — we refresh every 3 years to stay ahead of it.' },
      ],
    },
    services: {
    ...
    manager: {
      initials: 'DM', name: 'Dana Mitchell', creds: 'CMCA®, AMS®, PCAM®', eyebrow: 'Regional Manager · Howard County',
      bio: '<strong>14 years</strong> managing Howard County associations. Lives in Ellicott City. On-site in the county Monday, Wednesday & Thursday. Specialty: Columbia village-association budgeting and developer-transition audits.',
    ...
    faq: [
      ...
      { q: 'Do you serve all of Howard County?', a: 'Yes — Columbia, Ellicott City, Elkridge, Jessup, Savage, Laurel, Fulton, Clarksville, Glenelg, and the rural west county. Our regional manager is on-site three days a week with response-driven visits in between.' },
      { q: 'How quickly can you take over our Howard County community?', a: '<strong>4–5 weeks</strong> from signed proposal for a self-managed transition; <strong>7 weeks</strong> when switching from another management company, to cover a full notice cycle. See the <a href="/solutions/switching-hoa-management-company">week-by-week timeline</a>.' },
      { q: 'What does HOA management cost in Howard County?', a: 'Full-service runs <strong>$28–$42 per unit per month</strong> depending on community size, vendor count, meeting cadence, and complexity. Financial-only is roughly 35–55% of that. We quote line-item — no setup fee, no transition fee.' },
      ...
      { q: 'Where is your Howard County office?', a: 'Headquarters is in Owings Mills (Baltimore County), with a satellite address in Ellicott City. Our Howard County manager works on-site three days a week. Main line: <strong>(443) 548-0191</strong>.' },
    ],
    resources: {
      ...
      groups: [
        { label: 'Permits, inspections & enforcement', items: [
          ...
          { name: 'Code Enforcement', org: 'Howard County DILP', use: 'Property-maintenance and zoning violations on the far side of the association line — where the covenant stops and county code starts.', href: 'https://www.howardcountymd.gov/inspections-licenses-permits/code-enforcement' },
        ...
        { label: 'Utilities & county services', items: [
          ...
          { name: 'Curbside Collection & Recycling', org: 'Howard County Bureau of Environmental Services', use: 'Eligibility rules — many private-road communities are excluded and must contract privately. Worth confirming before a board budgets for it.', href: 'https://www.howardcountymd.gov/public-works/recycling-trash' },
  ...
  'carroll-county': {
    ...
    hero: {
      ...
      lede: 'Westminster, Eldersburg, Sykesville, Mount Airy — Carroll County associations are smaller, newer, and more likely to be self-managed than anywhere else in our footprint. We price and staff for that instead of pretending it’s Columbia.',
      stats: [
        { num: '2006', label: 'Managing Carroll County associations since' },
        { num: 'AAMC®', label: 'CAI’s highest accreditation · AMS on staff', gold: true },
        { num: '< 1 hr', label: 'On-site response from Owings Mills' },
      ],
    },
    intro: {
      eyebrow: 'Local Context',
      ...
      body: [
        'The median Carroll County association we manage is 64 units. That is less than a third of the Howard County median — and it changes everything about how management should be priced and staffed. A 64-unit HOA does not need a full-time on-site presence. It needs accurate books, a reserve study that holds up, covenant enforcement that does not create neighbors-suing-neighbors, and someone who answers the phone.',
        ...
        'Roughly 70% of the county’s associations are still self-managed. Our financial-only tier exists largely for them.',
      ],
      atAGlance: [
        { label: 'HOA-governed homes', value: '11,800+' },
        { label: 'Associations county-wide', value: '240+' },
        { label: 'Median association size', value: '64 units' },
        { label: 'Median assessment', value: '$195/mo' },
      ],
    },
    cities: {
      eyebrow: 'Cities & Towns We Serve',
      title: 'Carroll County communities, <em>by town.</em>',
      lede: 'Seven town pages sit under this one — each with the local association types, the neighborhoods we cover, and what management costs there.',
      list: [
        { name: 'Westminster', slug: 'westminster', focus: 'Town-center condo · Single-family', note: 'Town-center condo, historic-district single-family', tag: 'County seat', hasPage: true },
        { name: 'Eldersburg', slug: 'eldersburg', focus: 'Townhome HOA · Private roads', note: 'Townhome HOAs, private roads, stormwater ponds', tag: 'Largest market', hasPage: true },
        { name: 'Sykesville', slug: 'sykesville', focus: 'Single-family HOA', note: 'Small-lot single-family, shared amenity HOAs', hasPage: true },
        { name: 'Mount Airy', slug: 'mount-airy', focus: 'Split-county · New build', note: 'Split-county associations, newer construction', hasPage: true },
        { name: 'Hampstead', slug: 'hampstead', focus: 'Single-family HOA', note: 'Small single-family HOAs, well & septic', hasPage: true },
        { name: 'Taneytown', slug: 'taneytown', focus: 'Rural HOA', note: 'Rural HOA, minimal common area', hasPage: true },
    ...
    local: {
      ...
      cards: [
        { tone: '', meta: 'Private roads', title: 'Roads the county will not take', body: 'Many Eldersburg and Sykesville developments own their roads outright. Repaving a private road is a <strong>six-figure event for a 60-unit HOA</strong> and belongs in a reserve study from day one, not the year the cracks appear.' },
        { tone: 'gold', meta: 'Stormwater management', title: 'SWM pond obligations', body: 'Post-2000 Carroll developments almost always carry a stormwater facility with a recorded maintenance agreement and <strong>county inspection on a fixed cycle</strong>. Missed inspections become enforcement, and enforcement becomes a special assessment.' },
        { tone: 'sage', meta: 'MD Code Real Prop. §11B', title: 'Reserve study requirement applies anyway', body: 'Maryland’s reserve-study requirement does not exempt small associations. A <strong>40-unit HOA has the same obligation</strong> as a 400-unit one — which is exactly why our financial-only tier includes reserve refresh.' },
      ],
    },
    services: {
    ...
    manager: {
      initials: 'RK', name: 'Ryan Kessler', creds: 'CMCA®, AMS®', eyebrow: 'Regional Manager · Carroll County',
      bio: '<strong>9 years</strong> managing Carroll and north Baltimore County associations. Lives in Eldersburg. On-site in the county Tuesday & Thursday. Specialty: small-association reserve planning and private-road capital budgeting.',
      phone: '(443) 548-0191', phoneHref: 'tel:+14435480191',
    },
    faq: [
      { q: 'Do you work with small Carroll County associations?', a: 'Yes — that is most of what we do here. The median Carroll association we manage is <strong>64 units</strong>. Our financial-only tier exists specifically for boards under about 80 units that want professional books without full-service pricing.' },
      { q: 'What does HOA management cost in Carroll County?', a: 'Full-service runs <strong>$26–$38 per unit per month</strong>; smaller associations sit at the higher end per unit because fixed work does not shrink with unit count. Financial-only is typically <strong>$450–$1,100 per month</strong> depending on size. Quoted line-item, no setup or transition fee.' },
      { q: 'Do you serve all of Carroll County?', a: 'Yes — Westminster, Eldersburg, Sykesville, Mount Airy, Hampstead, Taneytown, Manchester, New Windsor, and the rural north county. Our manager is on-site Tuesday and Thursday, and we are 25 minutes from Owings Mills.' },
      ...
      { q: 'How quickly can you take over?', a: '<strong>3–4 weeks</strong> from signed proposal for a self-managed transition — faster than our larger-county average because the record sets are smaller. <strong>7 weeks</strong> when switching from another company, to cover the notice cycle.' },
    ...
    resources: {
      ...
      groups: [
        ...
        { label: 'Records, filings & liens', items: [
          { name: 'Land Records', org: 'Circuit Court for Carroll County', use: 'Recording covenant amendments, bylaw restatements, and association liens.', href: 'https://www.mdcourts.gov/clerks/carroll/landrecords' },
        ...
        { label: 'Utilities & county services', items: [
          ...
          { name: 'Well & Septic Program', org: 'Carroll County Health Dept. / MDE', use: 'Shared-well and community-septic obligations across the rural north county.', href: 'https://health.carrollcountymd.gov' },
        ]},
        { label: 'Governance & industry', items: [
