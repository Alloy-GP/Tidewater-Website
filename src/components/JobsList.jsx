    ...
    <section className="tw-section tw-section-linen tw-jobs" id="openings">
      <div className="tw-container">
        ...
        <div className="tw-section-head-left">
          <div className="tw-eyebrow">Careers</div>
          <h2 className="tw-section-title">Build your career <em>with Tidewater.</em></h2>
          <p className="tw-section-lede">Whatever we&rsquo;re hiring for is posted on our applicant portal — full descriptions, requirements, and an online application, all in one place.</p>
        </div>
        ...
        <div className="tw-jobs-portal">
          <div className="tw-jobs-portal-main">
            ...
            <p className="tw-jobs-portal-body">Search whatever is currently posted, read the full description, and apply directly through the portal. Openings are added as they become available.</p>
          ...
          <aside className="tw-jobs-portal-side" aria-label="Our teams">
            <div className="tw-jobs-portal-side-eyebrow">Our teams</div>
